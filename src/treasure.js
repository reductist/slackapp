...
const findTreasure = (type, tableID) => {
  if (type === 'treasure') {
    if (tableID >= 0 && tableID <= 4) return hoardTreasure0_4
    else if (tableID >= 5 && tableID <= 10) return hoardTreasure5_10
    else if (tableID >= 11 && tableID <= 16) return hoardTreasure11_16
    else if (tableID >= 17) return hoardTreasure17
  }
  else if (type === 'coins') {
    if (tableID >= 0 && tableID <= 4) return coinHoard.coins0_4
    else if (tableID >= 5 && tableID <= 10) return coinHoard.coins5_10
    else if (tableID >= 5 && tableID <= 10) return coinHoard.coins11_16
    else if (tableID >= 17) return coinHoard.coins17
  }
  else return;
}
